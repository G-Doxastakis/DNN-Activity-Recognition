...
print(model.summary())
#motionDataset.confusionMatrix(model, motionDataset.randgenerator(data, idx_test, sequence_len), 100, class_names)
...
motionDataset.exportmodel('CNN_Phone','conv1d_1_input','dense_2/Softmax')
